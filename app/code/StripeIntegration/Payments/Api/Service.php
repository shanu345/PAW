...
class Service implements ServiceInterface
{
    ...
    public function __construct(
        ...
        $this->config = $config;
        $this->stripeCustomer = $stripeHelper->getCustomerModel();
    ...
    public function redirect_url()
    {
        ...
        switch ($order->getPayment()->getMethod()) {
            case 'stripe_payments_checkout_card':
                return $checkout->getStripePaymentsCheckoutSessionId();
        ...
        try
        {
            ...
            foreach ($rates as $rate) {
                ...
                $result[] = [
                    ...
                    'amount' => $this->stripeHelper->convertMagentoAmountToStripeAmount($shouldInclTax ? $rate->getPriceInclTax() : $rate->getPriceExclTax(), $currency)
                ];
            }
    ...
    public function place_order($result, $location)
    {
        ...
        try {
            ...
            if ($location != "checkout" && !$quote->isVirtual())
            {
                // Set Shipping Address
            ...
            $paymentMethodType = $this->stripeHelper->getPRAPIMethodType();
        ...
        {
            $this->stripeHelper->dieWithError($e->getMessage(), $e);
        }
    }
    ...
    */
    ...
    public function getProductApplePayParams($productId, $attribute)
    {
        ...
        $productTotal = $this->stripeHelper->convertMagentoAmountToStripeAmount($price, $currency);
        $amount += $productTotal;
    ...
    {
        $quote = $this->stripeHelper->getQuote();
